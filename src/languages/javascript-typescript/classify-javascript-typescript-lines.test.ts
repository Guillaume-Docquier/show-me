...
import { collectDependencyRequests } from "./collect-dependency-requests.js"
...
function parseSyntax(
  ...
  const syntax = collectDependencyRequests({ path: path.value, absolutePath: fileName, sourceText })
