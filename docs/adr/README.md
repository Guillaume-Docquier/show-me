...
| [003](./003-use-sigma-graphology-forceatlas2.md)           | Use Sigma.js, Graphology, and ForceAtlas2 for the initial 2D graph.                              | Changing graph rendering, graph storage, layout, or UI framework choices.                     |
