...
| [002](./002-use-oxc-for-javascript-typescript-analysis.md)  | Use Oxc for syntax-level JavaScript and TypeScript dependency analysis and resolution.           | Changing JS/TS parsing, resolution, or supported dependency syntax.                           |
